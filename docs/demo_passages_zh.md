...
$$
\texttt{python Xi/LPM/scripts/extract_demo_passages.py}
$$

调用 DeepSeek 对前 8 条候选做结构化标注：

$$
\texttt{python Xi/LPM/scripts/extract\_demo\_passages.py --annotate --llm-limit 8}
$$

使用更强模型：

$$
\texttt{python Xi/LPM/scripts/extract\_demo\_passages.py --annotate --model deepseek-v4-pro}
$$
